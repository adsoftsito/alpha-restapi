...
const { truck } = require('../models');	// Sequelize
...
*/
    ...
    */})
    ...
    controllerHelper.handleErrorResponse(MODULE_NAME, getTrucks.name, error, res);
  }
}
...
function getTruckById(req, res) {
  try {
    ...
    controllerHelper.handleErrorResponse(MODULE_NAME, getTruckById.name, error, res);
  }
